...
EXTRA_MODEL_FIELDS = (
      (
	  "cartridge.shop.models.Product.short_descript",
	  "TextField",
	  ("Short desc",),
	  {"blank": True},
      ),
...
ALLOWED_HOSTS = ['128.199.160.27','127.0.0.1','localhost']
...
AWS_ACCESS_KEY_ID = 'AKIAIEGR7TZSQF2MVOOQ' 
AWS_SECRET_ACCESS_KEY = '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' 
EMAIL_HOST_USER = 'davit' 
EMAIL_USE_TLS = True 
