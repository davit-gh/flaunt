...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.feedback_date'
        db.add_column(u'flaunt_feedback', 'feedback_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.feedback_date'
        db.delete_column(u'flaunt_feedback', 'feedback_date')
