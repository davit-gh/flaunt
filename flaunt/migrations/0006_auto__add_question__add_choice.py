...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'flaunt.choice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['flaunt.Question']"}),
            'votes': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'flaunt.countrylist': {
            'Meta': {'object_name': 'Countrylist'},
            'carriers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['flaunt.Carrierlist']", 'symmetrical': 'False'}),
