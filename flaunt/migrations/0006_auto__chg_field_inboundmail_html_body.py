...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inboundmail.html_body'
        db.alter_column(u'flaunt_inboundmail', 'html_body', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Inboundmail.html_body'
        db.alter_column(u'flaunt_inboundmail', 'html_body', self.gf('django.db.models.fields.CharField')(max_length=800))
