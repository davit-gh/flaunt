...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'flaunt_homepage', (
            ...
            ('featured_portfolio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flaunt.Portfolio'], null=True, blank=True)),
        ))
        db.send_create_signal(u'flaunt', ['HomePage'])

        # Adding model 'FAQ'
        db.create_table(u'flaunt_faq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('faqpage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='que_ans', to=orm['flaunt.FAQPage'])),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'flaunt', ['FAQ'])

        # Adding model 'FAQPage'
        db.create_table(u'flaunt_faqpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'flaunt', ['FAQPage'])

        # Adding model 'Slide'
        db.create_table(u'flaunt_slide', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'flaunt_portfolio', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'flaunt', ['Portfolio'])

        # Adding model 'PortfolioItem'
        db.create_table(u'flaunt_portfolioitem', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
        ...
        db.send_create_signal(u'flaunt', ['PortfolioItem'])

        # Adding M2M table for field categories on 'PortfolioItem'
        m2m_table_name = db.shorten_name(u'flaunt_portfolioitem_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('portfolioitem', models.ForeignKey(orm[u'flaunt.portfolioitem'], null=False)),
        ...
        db.create_table(u'flaunt_portfolioitemimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('portfolioitem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['flaunt.PortfolioItem'])),
            ('file', self.gf('mezzanine.core.fields.FileField')(max_length=200)),
        ))
        db.send_create_signal(u'flaunt', ['PortfolioItemImage'])

        # Adding model 'PortfolioItemCategory'
        db.create_table(u'flaunt_portfolioitemcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'flaunt', ['PortfolioItemCategory'])

        # Adding model 'AddFieldsToProducts'
        db.create_table(u'flaunt_addfieldstoproducts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='supplementary', to=orm['shop.Product'])),
            ('short_desco', self.gf('mezzanine.core.fields.RichTextField')(blank=True)),
        ))
        db.send_create_signal(u'flaunt', ['AddFieldsToProducts'])
        ...
        # Adding model 'CarrierlistPriority'
        db.create_table(u'flaunt_carrierlistpriority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carrier', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'flaunt', ['CarrierlistPriority'])

        # Adding M2M table for field countries on 'CarrierlistPriority'
        m2m_table_name = db.shorten_name(u'flaunt_carrierlistpriority_countries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('carrierlistpriority', models.ForeignKey(orm[u'flaunt.carrierlistpriority'], null=False)),
            ('countrylist', models.ForeignKey(orm[u'flaunt.countrylist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['carrierlistpriority_id', 'countrylist_id'])

        # Adding model 'CarrierlistRegular'
        db.create_table(u'flaunt_carrierlistregular', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carrier', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'flaunt', ['CarrierlistRegular'])

        # Adding M2M table for field countries on 'CarrierlistRegular'
        m2m_table_name = db.shorten_name(u'flaunt_carrierlistregular_countries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('carrierlistregular', models.ForeignKey(orm[u'flaunt.carrierlistregular'], null=False)),
            ('countrylist', models.ForeignKey(orm[u'flaunt.countrylist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['carrierlistregular_id', 'countrylist_id'])

        # Adding model 'Feedback'
        db.create_table(u'flaunt_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prod', to=orm['shop.Product'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='usr', to=orm['auth.User'])),
            ('item_title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'flaunt', ['Feedback'])

        # Adding model 'Btcinvoices'
        db.create_table(u'flaunt_btcinvoices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('transaction_hash', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value_in_btc', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'flaunt', ['Btcinvoices'])

        # Adding model 'Pendingbtcinvoices'
        db.create_table(u'flaunt_pendingbtcinvoices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('transaction_hash', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value_in_btc', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'flaunt', ['Pendingbtcinvoices'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'flaunt_homepage')

        # Deleting model 'FAQ'
        db.delete_table(u'flaunt_faq')

        # Deleting model 'FAQPage'
        db.delete_table(u'flaunt_faqpage')

        # Deleting model 'Slide'
        db.delete_table(u'flaunt_slide')

        # Deleting model 'Portfolio'
        db.delete_table(u'flaunt_portfolio')

        # Deleting model 'PortfolioItem'
        db.delete_table(u'flaunt_portfolioitem')

        # Removing M2M table for field categories on 'PortfolioItem'
        db.delete_table(db.shorten_name(u'flaunt_portfolioitem_categories'))

        # Deleting model 'PortfolioItemImage'
        db.delete_table(u'flaunt_portfolioitemimage')

        # Deleting model 'PortfolioItemCategory'
        db.delete_table(u'flaunt_portfolioitemcategory')

        # Deleting model 'AddFieldsToProducts'
        db.delete_table(u'flaunt_addfieldstoproducts')

        # Deleting model 'Countrylist'
        db.delete_table(u'flaunt_countrylist')

        # Deleting model 'CarrierlistPriority'
        db.delete_table(u'flaunt_carrierlistpriority')

        # Removing M2M table for field countries on 'CarrierlistPriority'
        db.delete_table(db.shorten_name(u'flaunt_carrierlistpriority_countries'))

        # Deleting model 'CarrierlistRegular'
        db.delete_table(u'flaunt_carrierlistregular')

        # Removing M2M table for field countries on 'CarrierlistRegular'
        db.delete_table(db.shorten_name(u'flaunt_carrierlistregular_countries'))

        # Deleting model 'Feedback'
        db.delete_table(u'flaunt_feedback')

        # Deleting model 'Btcinvoices'
        db.delete_table(u'flaunt_btcinvoices')

        # Deleting model 'Pendingbtcinvoices'
        db.delete_table(u'flaunt_pendingbtcinvoices')
