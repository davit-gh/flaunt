...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.additional'
        db.add_column(u'shop_product', u'additional',
                      self.gf('mezzanine.core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.callback_uuid'
        db.delete_column(u'shop_order', u'callback_uuid')

        # Deleting field 'ProductVariation.option3'
        db.delete_column(u'shop_productvariation', u'option3')

        # Adding field 'Product.balance'
        db.add_column(u'shop_product', u'balance',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)

        # Deleting field 'Product.short_desc'
        db.delete_column(u'shop_product', u'short_desc')

        # Deleting field 'Product.additional'
        db.delete_column(u'shop_product', u'additional')
    ...
    models = {
        ...
        u'shop.order': {
            ...
            u'callback_uuid': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '36'}),
