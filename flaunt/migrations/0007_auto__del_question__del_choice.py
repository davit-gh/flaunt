...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'flaunt_question')

        # Deleting model 'Choice'
        db.delete_table(u'flaunt_choice')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'flaunt_question', (
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'flaunt', ['Question'])

        # Adding model 'Choice'
        db.create_table(u'flaunt_choice', (
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('choice_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flaunt.Question'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'flaunt', ['Choice'])
