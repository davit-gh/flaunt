...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field countries on 'Carrierlist'
        db.delete_table(db.shorten_name(u'flaunt_carrierlist_countries'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field countries on 'Carrierlist'
        m2m_table_name = db.shorten_name(u'flaunt_carrierlist_countries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('carrierlist', models.ForeignKey(orm[u'flaunt.carrierlist'], null=False)),
            ('countrylist', models.ForeignKey(orm[u'flaunt.countrylist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['carrierlist_id', 'countrylist_id'])
