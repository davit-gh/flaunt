...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Inboundmail.attachment'
        db.delete_column(u'flaunt_inboundmail', 'attachment')


    def backwards(self, orm):
        # Adding field 'Inboundmail.attachment'
        db.add_column(u'flaunt_inboundmail', 'attachment',
